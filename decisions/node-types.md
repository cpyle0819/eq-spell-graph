...
Current: `spell`, `npc`, `zone`, `stance`, `invocation`, `ability`, `spell_line`, `quest`, `quest_group`, `item`, `faction`, `era`. Generic typed nodes avoid schema changes when adding entity types.
